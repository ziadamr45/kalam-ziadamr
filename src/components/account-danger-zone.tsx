  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-xs leading-7" style={{ color: "#7F1D1D" }}>
        كما وعدتِ في سياسة الخصوصية — محو برمجي فوري وشامل بلا استبقاء: يمسح حسابك وكل تعليقاتك وردودك
        وتصويتاتك وتفاعلاتك ورصيد أثرك وسجل أثرك ومكتبتك المتزامنة ومواضع قراءتك ونقاشاتك مع الذكاء
        الاصطناعي وإشعاراتك وجلساتك وأجهزتك المسجلة — فورًا ودون رجعة، وتُحذف صورك الشخصية المرفوعة من
        التخزين السحابي لحظةً. لقطات الجهاز داخل متصفحك تبقى لك، وامسحها من صفحة «قراءاتي المحفوظة» إن
        أردت. هذا الإجراء لا يمكن التراجع عنه مطلقًا.
      </p>
